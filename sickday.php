			...
			<div class="row">
                  <div class="col-md-12">
					<div id="time" >
                              ...
                              Sick Day
                              <input type="date" name="sickDay" value="">
...
if ($conn->connect_error) {
  ...
  $sql = "INSERT INTO sickdays (sickDay, user_id, officeManager) VALUES ('$sickDay', '$user_id', '$officeManager')" or die("Error in loggin process"); 
