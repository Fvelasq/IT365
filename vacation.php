...
<head>
    ...
    <title>Vacation Submission</title>
			...
			<div class="row">
                  <div class="col-md-12">
                              ...
                              <form method="post" action="">
                                <br><br><br>
                              <h2>Vacation Submission</h2> 
                              <h3>Employee ID</h3>
                              <input type="number" name="user_id" value=""> 
                              <h3>Manager</h3>
                              <input type="radio" name="officeManager" value="DJ">DJ <br>   
                              <input type="radio" name="officeManager" value="Melissa">Melissa<br>                  
                              <h3>Vacation Start</h3>
                              <input type="date" name="vacationStart" value="">
                              <h3>Vacation End</h3>
                              <input type="date" name="vacationEnd" value="">
...
if ($conn->connect_error) {
  ...
  $sql = "INSERT INTO vacation (dayDate, vacationStart, vacationEnd, user_id, officeManager) VALUES ('$dayDate','$vacationStart', '$vacationEnd', '$user_id', '$officeManager')" or die("Error in loggin process"); 
