			...
			<div class="row">
                  <div class="col-md-12">
					<div id="time" >
                              ...
                              Punch in time
                              <input type="time" name="SignOutTime" value="">
                              Today's date
...
if ($conn->connect_error) {
  ...
  $sql = "INSERT INTO punchclock (dayDate, SignOutTime, user_id, officeManager) VALUES ('$dayDate','$SignOutTime', '$user_id', '$officeManager')" or die("Error in loggin process"); 
